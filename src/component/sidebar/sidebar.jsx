              ...
              <ListItemIcon>
                {index % 2 === 0 ? (
                  <Link to="/register">
                    ...
                    <img
                      className="img-icon"
                      src="https://corecampus.s3.ap-south-1.amazonaws.com/images/module_images/assignments.svg"
                      alt=""
                    />
                  </Link>
                ) : (
                  <Link to="/detail">
                    <img
                      className="img-icon"
                      src="https://www.flaticon.com/premium-icon/icons/svg/2117/2117281.svg"
                      alt=""
                    />
                  </Link>
                )}
            ...
            <ListItem button key={text}>
              <ListItemIcon>
                {index % 2 === 0 ? (
                  <Link to="/cardsGroup">
                    <img
                      src="https://www.flaticon.com/svg/static/icons/svg/3588/3588693.svg"
                      alt=""
                    />
                  </Link>
                ) : (
            ...
            <ListItem button key={text}>
              <ListItemIcon>
                {index % 2 === 0 ? (
                  ...
                  <Link to="/teachers">
                    <img
                      src="https://www.flaticon.com/svg/static/icons/svg/906/906175.svg"
                      alt=""
                    />{' '}
                  </Link>
                )}
              ...
              <ListItemIcon>
                {index % 2 === 0 ? (
                  <Link to="/adminpanel">
                    {' '}
                    <img
                      src="https://www.flaticon.com/svg/static/icons/svg/2913/2913968.svg"
                      alt=""
                    />{' '}
                  </Link>
                ) : (
